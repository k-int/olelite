...
public class GokbDiffEngine {
  ...
  // Closure Definitions:: newTippClosure(ctx, tipp_record, auto_accept)
  //                       updatedTippClosure(ctx, new_tipp_record, original_tipp_record, tipp_diff, auto_accept)
  //                       deletedTippClosure(ctx, tipp_record, auto_accept)
  //                       pkgPropChangeClosure(ctx, property, value, auto_accept);
  //                       tippUnchangedClosure(ctx, tipp_record);
